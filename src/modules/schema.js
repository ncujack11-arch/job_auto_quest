...
(function () {
  ...
  const K = {
    ...
    // 教育
    school: ['学校', '毕业院校', '院校', '大学', '学院', '就读学校', '学校名称', '毕业院校名称', '最高学历学校', '就读院校', '毕业学校', 'school', 'university', 'college', 'institution', 'campus'],
    degree: ['学历', '最高学历', '学历层次', '学位', 'degree', 'education level', 'qualification'],
    major: ['专业', '主修专业', '所学专业', '专业名称', '主修', 'major', 'specialty', 'specialization', 'discipline'],
    eduStart: ['入学时间', '入学年月', '开始时间', '起始时间', 'enroll', 'start date', 'admission'],
    eduEnd: ['毕业时间', '毕业年月', '结束时间', '预计毕业', 'graduation', 'graduate', 'end date'],
    gpa: ['gpa', '绩点', '平均成绩', '成绩排名', '平均分', 'gpa成绩'],
    ...
    // 实习
    intCompany: ['实习公司', '实习单位', '公司名称', '单位名称', '所在公司', '工作单位', '实习机构', 'company', 'employer', 'organization', 'corporation'],
    intDepartment: ['部门', '实习部门', 'department', 'division'],
    intPosition: ['实习岗位', '职位', '岗位名称', '任职岗位', '担任职位', '实习职位', '职位名称', 'position', 'job title', 'post'],
    ...
    // 求职意向
    targetPosition: ['期望岗位', '意向岗位', '求职岗位', '应聘岗位', '期望职位', '意向职位', '目标岗位', '岗位', '职位', 'position', 'job', 'career'],
    targetCity: ['期望城市', '意向城市', '工作城市', '工作地点', '意向地', '期望地点', 'city', 'location'],
    expectedSalary: ['期望薪资', '期望薪酬', '期望待遇', '期望工资', '薪资要求', '期望月薪', 'salary', 'pay', 'compensation'],
  ...
  const CATEGORIES = [
    {
      ...
      fields: [
        ...
        { key: 'ethnicity', label: '民族', type: F.text, kw: ['民族', 'ethnicity', 'nationality'] },
        { key: 'overseas', label: '海外留学经历', type: F.select, options: ['是', '否'], kw: ['海外留学', '留学经历', '海外经历', '海外学习', 'overseas', 'abroad', '留学'] },
        { key: 'postgradPlan', label: '考研/考博/出国计划', type: F.select, options: ['是', '否'], kw: ['考研', '考博', '出国计划', '升学计划', '深造计划', '考研考博', 'postgraduate'] },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: 'targetCity2', label: '期望城市二', type: F.text, kw: ['期望工作地点二', '期望城市二', '第二期望城市', '第二工作地点', '工作地点二', '期望地点二', '城市2', 'city2', 'second city'] },
        { key: 'interviewCity', label: '参加面试城市', type: F.text, kw: ['面试城市', '面试地点', '面试地', '面试地区', 'interview city', '面试'] },
        { key: 'complyAssignment', label: '服从公司分配', type: F.select, options: ['是', '否'], kw: ['服从分配', '服从公司分配', '接受分配', '服从调配', '公司分配', '服从安排', 'assignment'] },
        { key: 'sourceChannel', label: '招聘信息来源', type: F.text, kw: ['招聘信息来源', '信息来源', '招聘渠道', '获知渠道', '信息来源渠道', 'source', '渠道来源'] },
